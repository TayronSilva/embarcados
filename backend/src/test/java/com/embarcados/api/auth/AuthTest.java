...
public class AuthTest {
    ...
    @Test
    void shouldThrowInvalidUserTypeExceptionWhenUserTypeIsUnsupported() {
        LoginRequestDTO loginRequestDTO = new LoginRequestDTO();
        loginRequestDTO.setUserType("admin");

        InvalidUserTypeException exception = assertThrows(
                InvalidUserTypeException.class,
                () -> authService.login(loginRequestDTO));

        assertEquals("Tipo de usuário inválido. Use 'company' ou 'driver'", exception.getMessage());
    }
    ...
    void shouldThrowInvalidCredentialsWhenCompanyPasswordDoesNotMatch() {
        ...
        loginRequestDTO.setUserType("company");
    ...
    void shouldThrowInvalidCredentialsWhenDriverPasswordDoesNotMatch() {
        ...
        loginRequestDTO.setPassword("senha123");
        loginRequestDTO.setUserType("driver");
